...
const spaceTexture = new THREE.TextureLoader().load("./images/party.jpg");
...
const jeffTexture = new THREE.TextureLoader().load("./images/speaker.png");
...
const moonTexture = new THREE.TextureLoader().load(
  "./images/disco-ball-texture.jpeg"
);
const normalTexture = new THREE.TextureLoader().load(
  "./images/disco-ball-mold.jpg"
);
